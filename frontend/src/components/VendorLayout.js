...
import {
  LayoutDashboard, User, Package, Building2,
  Calendar, Image, Mail, Shield, LogOut, ChevronLeft, ChevronRight
} from 'lucide-react';
...
function VendorSidebar() {
  ...
  const navItems = [
    { path: '/vendor/dashboard', icon: <LayoutDashboard size={16} />, label: 'Dashboard' },
    { path: '/vendor/profile/edit', icon: <User size={16} />, label: 'Profile' },
    { path: '/vendor/packages', icon: <Package size={16} />, label: 'Packages' },
    { path: '/vendor/facilities', icon: <Building2 size={16} />, label: 'Facilities' },
    { path: '/vendor/availability', icon: <Calendar size={16} />, label: 'Availability' },
    { path: '/vendor/portfolio', icon: <Image size={16} />, label: 'Portfolio' },
    { path: '/vendor/enquiries', icon: <Mail size={16} />, label: 'Enquiries' },
    { path: '/vendor/verification', icon: <Shield size={16} />, label: 'Verification' },
  ];
      ...
      {isExpanded ? (
        <div style={{
          ...
          <div style={{ overflow: 'hidden' }}>
            ...
            <p style={{ margin: 0, fontSize: '10px', color: gold, fontWeight: '600', letterSpacing: '0.06em' }}>VENDOR</p>
          </div>
        </div>
      ) : (
        <div style={{
